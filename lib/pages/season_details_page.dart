...
class _SeasonDetailsPageState extends State<SeasonDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> onToggleWatched(Episode episode, bool watched) =>
        context.dispatchAndWait(ToggleEpisodeWatchedAction(widget.tvShowId, episode, watched));
    Future<void> onMarkAllWatched() => context.dispatchAndWait(MarkSeasonAsWatchedAction(widget.tvShowId, episodes));
